...
@Entity
@Audited
@Table(name = "foto_prefeitura")
@SequenceGenerator(name = "SE_ARQUIVO_PLC", sequenceName = "SE_ARQUIVO_PLC")
public class FotoPrefeitura extends PlcBaseMapFile {
	...
	@NotAudited
	@OneToOne(targetEntity = FotoConteudoPrefeitura.class, fetch = FetchType.LAZY, cascade = CascadeType.ALL)
